...
import {GroupItemProps, GroupItemProvide, makeGroupItemProps, useGroupItem} from "@/composables/groupItem.ts";
...
const slideGroupItem = useGroupItem(props as any as GroupItemProps, EvSlideGroupSymbol);
