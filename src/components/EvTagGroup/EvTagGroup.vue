...
import {EvTagGroupSlots, EvTagGroupSymbol, makeEvTagGroupProps} from "./EvTagGroup.ts";
...
const { isSelected, select, next, previous, selected } = useGroup(props as any as GroupProps, EvTagGroupSymbol);
