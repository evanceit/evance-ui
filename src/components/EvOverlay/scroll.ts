...
import {effectScope, EffectScope, nextTick, onScopeDispose, PropType, Ref, watchEffect} from "vue";
...
export const makeScrollStrategyProps = propsFactory({
    scrollStrategy: {
        type: [String, Function] as PropType<ScrollStrategyProps['scrollStrategy']>,
        default: 'block',
