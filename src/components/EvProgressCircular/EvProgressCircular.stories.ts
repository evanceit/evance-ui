...
const meta: Meta<typeof EvProgressCircular> = {
    ...
    argTypes: {
        default: {
            control: "text",
            description:
                "Allows any content to be placed in the middle of the progress circle. " +
        ...
        rotate: {
            ...
            description:
                "Set the progress bar starting angle in degrees. Defaults to `0` which, like a clock, is at the top and rotates clockwise.",
        },
        size: {
            control: {
                type: "range",
            ...
            description:
                "The `default` size is `20px x 20px`, which allows an `indeterminate` progress bar to be shown within other components such as buttons. " +
        ...
        thickness: {
            ...
            description:
                "The thickness/width of the progress bar may be supplied as a numeric value. " +
...
export const Primary: Story = {
    render: (args: any) => ({
        ...
        template:
            '<ev-progress-circular v-bind="args">{{ args.default }}</ev-progress-circular>',
    }),
};
