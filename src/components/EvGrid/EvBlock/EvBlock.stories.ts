    ...
    argTypes: {
        alignSelf: {
            ...
            mapping: {
                ...
                'baseline': 'baseline',
                'stretch': 'stretch',
                "{ xs: 'center', md: 'end', xl: 'start' }": { xs: 'center', md: 'end', xl: 'start' }
            },
        ...
        width: {
            ...
            mapping: {
                ...
                '200': 200,
                '300px': '300px',
                "{ xs: 200, md: 400, xl: '100%' }": { xs: 200, md: 400, xl: '100%' }
            },
    ...
    render: (args: any) =>  ({
        ...
        template: `
            <ev-layout style="height: 300px;">
                <ev-block v-bind="args" style="background: var(--background-muted)">
                    <h3>Try me</h3>
