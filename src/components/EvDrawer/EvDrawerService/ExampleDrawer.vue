...
const dynamicComponent = defineAsyncComponent(() => import("@/components/EvDrawer/EvDrawerService/ExampleDrawer.vue"));
...
<template>
    <h3>
        Example Drawer #{{ drawerRef?.id }}
    </h3>
    <p>
        This is an example drawer component with an initial title waiting to be updated by a child drawer:
    </p>
    <p>
        {{ data.greeting }}
    </p>
