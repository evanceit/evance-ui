...
export class Browser {
    ...
    public static readonly supportsIntersection: boolean = this.hasWindow && ('IntersectionObserver' in window);
    ...
    public static readonly supportsFocusVisible: boolean = this.hasWindow && (window.CSS?.supports?.('selector(:focus-visible)'));
}