...
import {listOpenStrategy, multipleOpenStrategy, singleOpenStrategy} from "@/composables/lists/open-strategy";
...
export const makeOpenStrategyProps = propsFactory({
    openStrategy: [String, Object] as PropType<OpenStrategyRef | OpenStrategy>,
 ...
 * @param props
 */
export function useOpenStrategy(props: OpenStrategyProps): ComputedRef<OpenStrategy> {
    return computed(() => {
